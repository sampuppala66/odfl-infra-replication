...
service_account_name = "odfl-hvr-sa-dev"
pilot_service_account_name = "odfl-pilot-sa-dev"
delta_vm_type = "n2-standard-4"
vm_instance_name = "odfl-pilot-hvr-vm"
delta_vm_disk_type = "pd-standard"
delta_vm_disk_size ="10"
resources_zone = "us-east1-c"
nat_ip = ["34.148.151.158"]
hostname = "odfl-pilot-hvr-vm-dev"
odfl_folder_id = "folders/878125556822"
monitoring_users =  ["group:adfs_gcp-sysops-monitoring_admin@odfl.com"]
developer_users =  ["group:adfs_gcp-developers_prod@odfl.com"]
sa_users =  ["group:adfs_gcp-dba_admin_prod@odfl.com"]
admins = ["group:adfs_gcp-dba_admin@odfl.com"]
reviewers =  ["group:adfs_gcp-dba_admin@odfl.com"]
tester_users =  ["group:adfs_gcp-testers_prod@odfl.com"]
vpc_name = "odfl-pilot-vpc"
subnet_name = "odfl-pilot-subnetwork-dev-us-east1"
